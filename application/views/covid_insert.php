...
<div class="container">
  ...
  <center><img src="https://media.istockphoto.com/vectors/man-using-protective-surgical-mask-for-covid-19-shield-with-particles-vector-id1248198864?k=20&m=1248198864&s=170667a&w=0&h=TzpBlHg-opAnkW9bT9o09V9Z6DeeC2aYwY-1hbXAOt4=" width="550" height="550">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" class="form-control" name="id" maxlength="13" style="width:400px;" placeholder="รหัสบัตรประจำตัวประชาชน" required>
</div>
    </div>
    <br><br><br><br><br><br>
<div class="form-group">
  <div class="col-sm-6">
	...
	<input type="text" class="form-control" name="name" style="width:400px;" placeholder="ชื่อ - สกุล" required>
		</div>
      </div>
      <br><br><br><br>
<div class="form-group">
	...
	<input type="date" class="form-control" name="day" style="width:400px;"  placeholder="วัน / เดือน / ปีเกิด" required>
		</div>
    </div>
    <br><br><br><br>
		<div class="form-group">
	...
	<input type="email"class="form-control" name="email" style="width:400px;" placeholder="อีเมลล์" required>
</div>
</div>
<br><br><br><br>
		<div class="form-group">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" class="form-control" name="phone" maxlength="10" style="width:400px;" placeholder="เบอร์ติดต่อ" required>
		</div>
    </div>
    <br><br><br><br>
		<div class="form-group">
	...
	<textarea type="textarea"class="form-control" name="address"  style="width:400px;" placeholder="ที่อยู่ที่สามารถติดต่อได้" rows="6" required></textarea>
		</div>
    </div>
  ...
  <select name="krom" id="krom" style="width:400px;" placeholder="แผนประกัน" required>
	...
	<select name="price" id="price" style="width:400px;" placeholder="แผนประกัน" required>
                <option value="750">แผนประกัน A ราคา 750</option>
                <option value="1500">แผนประกัน B ราคา 1,500</option>
  </select>
</div>
    </div>
