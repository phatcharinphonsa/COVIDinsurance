...
<center><h4 class="card-header">รายชื่อข้อมูลผู้สมัครประกันชีวิต</h4><center>
<div class="row">
  <div class="col-sm-2">
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><?php echo $row->l_day;?></td>
        <td><?php echo $row->l_email; ?></td>
        <td><?php echo $row->l_phone; ?></td>
        <td><?php echo $row->l_address; ?></td>
        <td><?php echo $row->l_krom; ?></td>
        <td><?php echo $row->l_price; ?></td>
        <td>
        <tb><a class="btn btn-warning" href='formEdit?l_id=<?php echo $row->l_id; ?>'>edit</a></tb>
        <tb><a class="btn btn btn-danger" href='formDelete?l_id=<?php echo $row->l_id; ?>'>delete</a></tb>
        </td>
    </tr>
  </div>
  <div class="col-sm-2">
