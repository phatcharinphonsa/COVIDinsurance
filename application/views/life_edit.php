...
<div class="container">
  ...
  <div class="col-sm-6">
	...
	<input type="text" class="form-control" name="l_name" style="width:400px;" placeholder="ชื่อ - สกุล" value="<?php echo $l_name; ?>" required>
  </div>
      </div>
      <br><br><br><br>
<div class="form-group">
	...
	<input type="date" class="form-control" name="l_day" style="width:400px;"  placeholder="วัน / เดือน / ปีเกิด" value= "<?php echo $l_day; ?>" required>
  </div>
    </div>
    <br><br><br><br>
		<div class="form-group">
	...
	<input type="email"class="form-control" name="l_email" style="width:400px;" placeholder="อีเมลล์" value="<?php echo $l_email; ?>" required>
  </div>
</div>
<br><br><br><br>
		<div class="form-group">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" maxlength="10" class="form-control" name="l_phone" style="width:400px;" placeholder="เบอร์ติดต่อ" value="<?php echo $l_phone; ?>" required>
  </div>
    </div>
    <br><br><br><br>
		<div class="form-group">
	...
	<textarea type="textarea"class="form-control" name="l_address" style="width:400px;" placeholder="ที่อยู่ที่สามารถติดต่อได้" rows="6" value="<?php echo $l_address; ?>" required></textarea>
  </div>
    </div>
  ...
  <select name="l_price" id="l_price" style="width:400px;" placeholder="แผนประกัน" value="<?php echo $l_krom; ?>" required>
	...
	<select name="l_price" id="l_price" style="width:400px;" placeholder="แผนประกัน" value="<?php echo $l_price; ?>" required>
